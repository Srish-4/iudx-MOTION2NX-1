...
# cleanup() {
#     echo "Interrupt signal received. Killing process with PID $pid2 "
#     kill -9 $pid2 
#     kill -9 $pid5
#     kill -9 $pid6
#     exit 1
