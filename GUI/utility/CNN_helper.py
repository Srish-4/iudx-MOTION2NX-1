...
def call():
    ...
    my_combo.grid(row=0, column=0, columnspan=4,
                  ipadx=300, ipady=10, padx=10, pady=10)
    ...
    my_image2 = canvas_1.create_image(
        WIDTH/2, HEIGHT/2, anchor=CENTER, image=back_image2)
    ...
    canvas.create_text(700/2, 512/2, anchor=CENTER,
                       text=details_smpc, fill="black", font=('sans 18 normal'))
    ...
    def client():
        ...
        my_red_image_1 = canvas_1.create_image(
            220, 155, anchor=CENTER, image=red_file_1)

        red_file_2 = PhotoImage(file="./utility/Images_Video/red.png")
        my_red_image_2 = canvas_1.create_image(
            220, 155, anchor=CENTER, image=red_file_2)

        yellow_file_1 = PhotoImage(file="./utility/Images_Video/yellow.png")
        my_yellow_image_1 = canvas_1.create_image(
            220, 440, anchor=CENTER, image=yellow_file_1)

        yellow_file_2 = PhotoImage(file="./utility/Images_Video/yellow.png")
        my_yellow_image_2 = canvas_1.create_image(
            220, 440, anchor=CENTER, image=yellow_file_2)
        ...
        while True:
            ...
            canvas_1.move(my_yellow_image_1, xVelocity_yellow_1,
                          yVelocity_yellow_1)
            canvas_1.move(my_yellow_image_2, xVelocity_yellow_2,
                          yVelocity_yellow_2)
    ...
    def server():
        ...
        my_yellow_image_4 = canvas_1.create_image(
            450, 145, anchor=CENTER, image=yellow_file_4)

        blue_file_1 = PhotoImage(file="./utility/Images_Video/blue.png")
        my_blue_image_1 = canvas_1.create_image(
            450, 145, anchor=CENTER, image=blue_file_1)

        blue_file_2 = PhotoImage(file="./utility/Images_Video/blue.png")
        my_blue_image_2 = canvas_1.create_image(
            450, 430, anchor=CENTER, image=blue_file_2)
        ...
        canvas_1.move(my_yellow_image_4, xVelocity_yellow_4,
                      yVelocity_yellow_4)
    ...
    def result():
        ...
        my_grey_image_1 = canvas_1.create_image(
            450, 150, anchor=CENTER, image=grey_file_1)
        xVelocity_grey_1 = 2.9*0.5
        yVelocity_grey_1 = 0
        grey_file_2 = PhotoImage(file="./utility/Images_Video/grey.png")
        my_grey_image_2 = canvas_1.create_image(
            450, 430, anchor=CENTER, image=grey_file_2)
    ...
    client_button = Button(window, text="Client", padx=55, pady=10, command=client,
                           highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))
    server_button = Button(window, text="Server", padx=45, pady=10, command=server,
                           highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))
    output_button = Button(window, text="Output", padx=20, pady=10, command=result,
                           highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))
    ...
    paint_button = Button(window, text="Draw your Number", padx=15, pady=10, command=lambda: painter(
        window), highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))
    upload_button = Button(window, text="MNIST", padx=45, pady=10, command=lambda: Uploader(
        window), highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))

    cifar_button = Button(window, text="CIFAR 10", padx=45, pady=10, command=lambda: cifar10(
        window), highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))
    pneumonia_button = Button(window, text="Pneumonia", padx=45, pady=10, command=lambda: pneumonia(
        window), highlightthickness=3, highlightbackground="black", font=('Times 20 bold'))

    paint_button.grid(row=3, column=0, padx=15, pady=20)
    upload_button.grid(row=3, column=1, padx=15, pady=20)
    cifar_button.grid(row=3, column=2, padx=15, pady=20)
    pneumonia_button.grid(row=3, column=3, padx=15, pady=20)
