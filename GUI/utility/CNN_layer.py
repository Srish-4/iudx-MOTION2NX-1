...
class ImageRadioButton(Frame):
    ...
    def on_select(self):
        ...
        if self.image_path == "/home/ankit/Downloads/iudx-MOTION2NX/GUI/aeroplane.png":
          window.destroy()
          cifar10.call(1)
          #1 for aeroplane
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/automobile.png":
          window.destroy()
          cifar10.call(2)
          # 2 for automobile
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/bird.png":
          window.destroy()
          cifar10.call(3)
          # 3 for bird
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/cat.png":
          window.destroy()
          cifar10.call(4)
          # 4 for cat
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/deer.png":
          window.destroy()
          cifar10.call(5)
          # 5 for deer
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/dog.png":
          window.destroy()
          cifar10.call(6)
          # 6 for dog
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/frog.png":
          window.destroy()
          cifar10.call(7)
          # 7 for frog
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/horse.png":
          window.destroy()
          cifar10.call(8)
          # 8 for horse
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/ship.png":
          window.destroy()
          cifar10.call(9)
          # 9 for ship
        elif self.image_path =="/home/ankit/Downloads/iudx-MOTION2NX/GUI/truck.png":
          window.destroy()
          cifar10.call(10)
          # 10 for truck
...
def call():
    ...
    clicked = StringVar()
    my_combo = ttk.Combobox(canvas_2, values=options,font=('sans 20 bold'), justify=CENTER, textvariable=clicked, style='W.TCombobox', state = "readonly",width=30)
    my_combo.grid(row = 0 , column=0,columnspan=4,ipadx=200,ipady=10, padx=(220,10), pady=(15,10),sticky="ew")
    my_combo.set( "Convolution Neural Network - CIFAR 10" )
    my_combo.bind("<<ComboboxSelected>>", display_selected)
    
    image_paths_uploaded = [
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/aeroplane.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/automobile.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/bird.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/cat.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/deer.png",
    ]
    ...
    image_paths_additional = [
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/dog.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/frog.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/horse.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/ship.png",
        "/home/ankit/Downloads/iudx-MOTION2NX/GUI/truck.png",
    ]
