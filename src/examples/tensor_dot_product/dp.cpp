//./bin/tensor_dot_product --my-id 0 --party 0,::1,7000 --party 1,::1,7001 --arithmetic-protocol
// beavy --boolean-protocol beavy --repetitions 1
//./bin/tensor_dot_product --my-id 1 --party 0,::1,7000 --party 1,::1,7001 --arithmetic-protocol
// beavy --boolean-protocol beavy --repetitions 1
...
std::optional<Options> parse_program_options(int argc, char* argv[]) {
  ...
  options.filename = getenv("BASE_DIR");
  if (vm["dp-id"].as<int>() == 0) {
    options.filename += "/src/examples/tensor_dot_product/input_dp0.txt";
    std::cout << options.filename << " "
              << "\n";
  } else if (vm["dp-id"].as<int>() == 1) {
    options.filename += "/src/examples/tensor_dot_product/input_dp1.txt";
    std::cout << options.filename << " "
              << "\n";
  } else {
